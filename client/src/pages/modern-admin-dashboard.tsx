...
export default function ModernAdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50">
      ...
      <div className="bg-gradient-to-r from-purple-600 via-blue-600 to-indigo-600 text-white p-4 md:p-6 shadow-xl">
          ...
          <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
            <div className="text-center md:text-left">
              <h1 className="text-2xl md:text-3xl font-bold flex items-center justify-center md:justify-start">
                <BarChart3 className="mr-2 md:mr-3 h-6 w-6 md:h-8 md:w-8" />
                Painel Administrativo
              </h1>
              <p className="text-purple-100 mt-1 text-sm md:text-base">Gerencie leads, projetos e cronogramas</p>
            </div>
            <Link href="/">
              <Button variant="outline" className="bg-white text-purple-600 hover:bg-purple-50 border-white w-full md:w-auto py-3 md:py-2 text-base md:text-sm rounded-xl md:rounded-md">
      ...
      <div className="max-w-7xl mx-auto p-4 md:p-6">
        {/* Dashboard Overview Cards - Mobile Nativo */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-6 md:mb-8">
          {Object.entries(dashboardMetrics).map(([key, value]) => (
            <Card key={key} className="bg-gradient-to-br from-white to-gray-50 shadow-lg border-0 hover:shadow-xl transition-all duration-300 rounded-2xl md:rounded-lg">
              <CardContent className="p-4 md:p-6">
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <p className="text-xs md:text-sm font-medium text-gray-600 mb-1">{key}</p>
                  ...
                  <div className={`h-10 w-10 md:h-12 md:w-12 rounded-xl md:rounded-lg flex items-center justify-center ml-2 ${
                    key.includes('Lucro') ? 
                    ...
                    {key.includes('Lucro') ? 
                      (value >= 0 ? <TrendingUp className="h-5 w-5 md:h-6 md:w-6 text-white" /> : <TrendingDown className="h-5 w-5 md:h-6 md:w-6 text-white" />) :
                     key.includes('Custos') ? 
        ...
        <Tabs defaultValue="leads" className="space-y-4 sm:space-y-6">
          <TabsList className="bg-white shadow-lg border border-gray-200 p-1 grid grid-cols-2 md:grid-cols-6 h-auto rounded-2xl md:rounded-xl">
            <TabsTrigger value="leads" className="data-[state=active]:bg-purple-600 data-[state=active]:text-white text-xs md:text-sm py-3 md:py-2 flex flex-col md:flex-row items-center rounded-xl md:rounded-lg">
              <Users className="h-4 w-4 md:h-4 md:w-4 md:mr-2 mb-1 md:mb-0" />
              <span className="hidden md:inline">Gerenciar </span>Leads
            </TabsTrigger>
            <TabsTrigger value="appointments" className="data-[state=active]:bg-blue-600 data-[state=active]:text-white relative text-xs md:text-sm py-3 md:py-2 flex flex-col md:flex-row items-center rounded-xl md:rounded-lg">
              <Calendar className="h-4 w-4 md:h-4 md:w-4 md:mr-2 mb-1 md:mb-0" />
              Agenda
            ...
            <TabsTrigger value="projects" className="data-[state=active]:bg-green-600 data-[state=active]:text-white text-xs md:text-sm py-3 md:py-2 flex flex-col md:flex-row items-center rounded-xl md:rounded-lg">
              <Settings className="h-4 w-4 md:h-4 md:w-4 md:mr-2 mb-1 md:mb-0" />
              Projetos
            </TabsTrigger>
            <TabsTrigger value="analytics" className="data-[state=active]:bg-orange-600 data-[state=active]:text-white text-xs md:text-sm py-3 md:py-2 flex flex-col md:flex-row items-center rounded-xl md:rounded-lg">
              <BarChart3 className="h-4 w-4 md:h-4 md:w-4 md:mr-2 mb-1 md:mb-0" />
              <span className="hidden md:inline">99Freelas </span>Analytics
            </TabsTrigger>
            <TabsTrigger value="guidelines" className="data-[state=active]:bg-indigo-600 data-[state=active]:text-white text-xs md:text-sm py-3 md:py-2 flex flex-col md:flex-row items-center rounded-xl md:rounded-lg">
              <Code className="h-4 w-4 md:h-4 md:w-4 md:mr-2 mb-1 md:mb-0" />
              <span className="hidden md:inline">Como Criar </span>Sistema
            </TabsTrigger>
            <TabsTrigger value="ai-analyzer" className="data-[state=active]:bg-purple-600 data-[state=active]:text-white text-xs md:text-sm py-3 md:py-2 flex flex-col md:flex-row items-center rounded-xl md:rounded-lg">
              <Brain className="h-4 w-4 md:h-4 md:w-4 md:mr-2 mb-1 md:mb-0" />
              <span className="hidden md:inline">IA </span>Analyzer
            </TabsTrigger>
          </TabsList>
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              {(appointment.status === 'scheduled' || appointment.status === 'pending' || appointment.status === 'confirmed') && (
                                <Button
                                  ...
                                  title="Desbloquear este horário na agenda"
                                >
                                  🔓 DESBLOQUEAR
                                </Button>
                              )}
                    ...
                    <Card key={appointment.id} className="bg-white shadow-sm hover:shadow-md transition-shadow">
                      <CardContent className="p-4">
                        ...
                        <div className="flex flex-wrap gap-2 pt-3 border-t border-gray-100">
                          ...
                          {/* BOTÃO DESBLOQUEAR HORÁRIO - MOBILE */}
                          {(appointment.status === 'scheduled' || appointment.status === 'pending' || appointment.status === 'confirmed') && (
                            <Button
                              variant="outline"
                              size="sm"
                              ...
                              disabled={updateAppointmentStatusMutation.isPending}
                              className="bg-orange-50 hover:bg-orange-100 text-orange-700 border-orange-200 flex-1 min-w-0"
                              title="Desbloquear este horário na agenda"
                            >
                              🔓 DESBLOQUEAR
                            </Button>
